...
//		frmMomentum.add(title);
	...
	run.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent arg0) { 
            ...
            //minor detail: the current config has it such that it will do alphabetic first, then index in string.
            //if we want to primarily sort by index in string, we need to sort the foundwords by index
            ...
            for(BadWord b : foundWords) {
            	...
            	int n = JOptionPane.showOptionDialog(null, b.getMessage() + b.getReplacement(), "Bad word found!",JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, o, o[1]);
            	if(n==0) {//replace
